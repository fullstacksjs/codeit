...
export const seedingClashOfCodePuzzles: Prisma.PuzzleCreateInput[] = [
  {
    ...
    initialTemplates: {
      create: [
        {
          language: 'JavaScript',
          template: generateStub('JavaScript', 'read LINE:string(101)\nwrite 0'),
        },
      ],
    },
    statement:
    ...
    testCases: {
      create: [
        ...
        { title: 'Test 3', assertion: '-3', input: '+++--*----+', mode: 'sample' },
        { title: 'Validator 3', assertion: '9', input: '++++-*+++++--', mode: 'final' },
        {
          title: 'Test 4',
          assertion: '-12',
          input: '--+++-+-+-+*+++-++++---+-*-+-+-+----++*++++--',
  ...
  },
  {
    ...
    initialTemplates: {
      create: [
        {
          language: 'JavaScript',
          template: generateStub('JavaScript', 'read s:string(10)\nread n:int\nwrite answer\n'),
        },
      ],
    },
    statement:
    ...
    testCases: {
      create: [
        ...
        { title: 'Validator 1', assertion: '"a"', input: 'faq\n2', mode: 'final' },
        { title: 'Test 2', assertion: '""', input: 'abc\n1', mode: 'sample' },
        { title: 'Validator 2', assertion: '""', input: 'learn\n1', mode: 'final' },
        { title: 'Test 3', assertion: '"zg"', input: 'zerg\n10', mode: 'sample' },
        { title: 'Validator 3', assertion: '"wtr"', input: 'winter\n42', mode: 'final' },
        { title: 'Test 5', assertion: '"clash"', input: 'clash\n32', mode: 'sample' },
        { title: 'Validator 5', assertion: '"codin"', input: 'codin\n32', mode: 'final' },
        { title: 'Test 5', assertion: '"ckes"', input: 'packers\n77', mode: 'sample' },
        { title: 'Validator 5', assertion: '"wtzy"', input: 'qwertzy\n99', mode: 'final' },
      ],
    },
  },
];
